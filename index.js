...
Module['FS_createPath']("/data/model", "map0", true, true);
    ...
    loadPackage({"files": [{"filename": "/data/img/creature.png", "start": 0, "end": 118523}, {"filename": "/data/img/equip_bullet_revolver.png", "start": 118523, "end": 267353}, {"filename": "/data/img/equip_hand.png", "start": 267353, "end": 381315}, {"filename": "/data/img/equip_revolver.png", "start": 381315, "end": 500989}, {"filename": "/data/img/equip_revolver_reload.png", "start": 500989, "end": 679943}, {"filename": "/data/img/item_bullet_revolver.png", "start": 679943, "end": 921128}, {"filename": "/data/img/item_hand.png", "start": 921128, "end": 1035328}, {"filename": "/data/img/item_revolver.png", "start": 1035328, "end": 1115407}, {"filename": "/data/img/tileset.png", "start": 1115407, "end": 1535652}, {"filename": "/data/model/base.obj", "start": 1535652, "end": 1562905}, {"filename": "/data/model/map0/event.txt", "start": 1562905, "end": 1562905}, {"filename": "/data/model/map0/map.mtl", "start": 1562905, "end": 1563077}, {"filename": "/data/model/map0/map.obj", "start": 1563077, "end": 1585604}, {"filename": "/data/model/map0/texture_1.png", "start": 1585604, "end": 2024367}], "remote_package_size": 2024367});

  })();

// end include: /tmp/tmp2487jurm.js
// include: /tmp/tmpitpk_ku0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpitpk_ku0.js
// include: /tmp/tmp6ymi0yai.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6ymi0yai.js
...
var ASM_CONSTS = {
  111304: () => { if (document.fullscreenElement) return 1; },  
 111350: () => { return document.getElementById('canvas').width; },  
 111402: () => { return parseInt(document.getElementById('canvas').style.width); },  
 111470: () => { document.exitFullscreen(); },  
 111497: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 111570: () => { if (document.fullscreenElement) return 1; },  
 111616: () => { return document.getElementById('canvas').width; },  
 111668: () => { return screen.width; },  
 111693: () => { document.exitFullscreen(); },  
 111720: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 111853: () => { return window.innerWidth; },  
 111879: () => { return window.innerHeight; },  
 111906: () => { if (document.fullscreenElement) return 1; },  
 111952: () => { return document.getElementById('canvas').width; },  
 112004: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112072: () => { if (document.fullscreenElement) return 1; },  
 112118: () => { return document.getElementById('canvas').width; },  
 112170: () => { return screen.width; },  
 112195: () => { return window.innerWidth; },  
 112221: () => { return window.innerHeight; },  
 112248: () => { if (document.fullscreenElement) return 1; },  
 112294: () => { return document.getElementById('canvas').width; },  
 112346: () => { return screen.width; },  
 112371: () => { document.exitFullscreen(); },  
 112398: () => { if (document.fullscreenElement) return 1; },  
 112444: () => { return document.getElementById('canvas').width; },  
 112496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 112564: () => { document.exitFullscreen(); },  
 112591: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 112649: () => { return screen.width; },  
 112674: () => { return screen.height; },  
 112700: () => { return window.screenX; },  
 112727: () => { return window.screenY; },  
 112754: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 112807: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 112878: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 112935: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 113191: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 113262: () => { if (document.fullscreenElement) return 1; },  
 113308: () => { return window.innerWidth; },  
 113334: () => { return window.innerHeight; },  
 113361: () => { if (document.pointerLockElement) return 1; }
};
...
var _wasm_new_vm = Module['_wasm_new_vm'] = createExportWrapper('wasm_new_vm', 0);
var _wasm_destroy_vm = Module['_wasm_destroy_vm'] = createExportWrapper('wasm_destroy_vm', 1);
var _wasm_eval = Module['_wasm_eval'] = createExportWrapper('wasm_eval', 2);
